...
namespace MultiTenantLMS.Migrations
{
    ...
    [Migration("20250816151635_AddUserEmailSeed")]
    partial class AddUserEmailSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MultiTenantLMS.Models.Enrollment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            EnrolledAt = new DateTime(2025, 8, 16, 20, 46, 31, 373, DateTimeKind.Local).AddTicks(2587),
                            Progress = 0.0,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 3,
                            EnrolledAt = new DateTime(2025, 8, 16, 20, 46, 31, 373, DateTimeKind.Local).AddTicks(2602),
                            Progress = 0.0,
                            UserId = 4
                        });
                });
